...
tree.status <- function(
  ...
  ## for edge form 2 --> triangle
    ...
    # AT
     # select the intersection coordinates for the triangle on AT line
     x.AT.inter.triangle.60 = inter.for.triangle(t.dist, c.r017, l.AT.b0, l.AT.b1,  c.x0, c.y0, c.r060, x.a, y.a, x.t, y.t, coordinate = "x" );
     # calculate y for AT triangle
     y.AT.inter.triangle.60 = inter.for.triangle(t.dist, c.r017, l.AT.b0, l.AT.b1,  c.x0, c.y0, c.r060, x.a, y.a, x.t, y.t, coordinate = "y" );
     #BT 
     # select the intersection coordinates for the triangle on BT line
     x.BT.inter.triangle.60 = inter.for.triangle(t.dist, c.r017, l.BT.b0, l.BT.b1,  c.x0, c.y0, c.r060, x.b, y.b, x.t, y.t, coordinate = "x" );
     # calculate y for BT triangle
     y.BT.inter.triangle.60 = inter.for.triangle(t.dist, c.r017, l.BT.b0, l.BT.b1,  c.x0, c.y0, c.r060, x.b, y.b, x.t, y.t, coordinate = "y" );
    ...
    # A = in =  point is outside triangle, so inside plot
     ...
     tree_status_AT_line = ifelse(edge_form == "2", p.site.triangle(x1.inter.AT, x2.inter.AT, y1.inter.AT, y2.inter.AT,
                                                                    c.x0, c.y0, c.r017,
                                                                    l.AT.b0, l.AT.b1,
                                                                    x.AT.inter.triangle.60, x.BT.inter.triangle.60, x.t, 
                                                                    y.AT.inter.triangle.60, y.BT.inter.triangle.60, y.t,
                                                                    x.tree, y.tree), NA);
     tree_status_BT_line = ifelse(edge_form == "2",p.site.triangle(x1.inter.BT, x2.inter.BT, y1.inter.BT, y2.inter.BT, 
                                                                   c.x0, c.y0, c.r017,
                                                                   l.BT.b0, l.BT.b1,
                                                                   x.AT.inter.triangle.60, x.BT.inter.triangle.60, x.t, 
                                                                   y.AT.inter.triangle.60, y.BT.inter.triangle.60, y.t,
     ...
     tree_status = case_when(edge_form == "2" & i_status.AT == "two I" & i_status.BT == "two I" ~ tree_stat_triangle,
                        ...
                        edge_form == "2" & i_status.AT != "two I" & i_status.BT == "two I" ~ tree_status_BT_line, 
                        edge_form == "2" & i_status.AT == "two I" & i_status.BT != "two I" ~ tree_status_AT_line,
...
inter.for.triangle <- function(t.dist, c.r0, l.b0, l.b1, c.x0, c.y0, c.r0.inter, x, y, x.t, y.t, coordinate){
...
# ------ 0.5.8.2.2. check if point is located on the triangle site of a line -------------------------------------------------------------------------------------
...
# ----- 0.5.9.4. selecting/ calculating total edge area per edge type per plot  ----------
...
# ----- 0.5.9.5. assign correct area to trees according to their category (A/B)  ----------
...
forest_edges_HBI.man <- forest_edges_HBI %>% 
  ...
  mutate(inter_1_dist = distance(X1_inter_AB_17, Y1_inter_AB_17, 0, 0),     # this is just to control if the whole thing worked and 
         ...
         azi_C_AB_inter_1 = azi(X1_inter_AB_17, Y1_inter_AB_17, 0, 0),
         azi_C_AB_inter_2 = azi(X2_inter_AB_17, Y2_inter_AB_17, 0, 0),
         # AT line 
         ...
         X_inter_AT_triangle_60 = inter.for.triangle(T_dist, data_circle$r0[3], b0_AT, b1_AT, 0, 0, data_circle$rmax[3]*2, X_A, Y_A, X_T, Y_T, coordinate = "x"),
         X_inter_BT_triangle_60 = inter.for.triangle(T_dist, data_circle$r0[3], b0_BT, b1_BT, 0, 0, data_circle$rmax[3]*2, X_B, Y_B, X_T, Y_T, coordinate = "x")) %>% 
  ...
  mutate(Y_inter_AT_triangle_60 = inter.for.triangle(T_dist, data_circle$r0[3], b0_AT, b1_AT, 0, 0, data_circle$rmax[3]*2, X_A, Y_A, X_T, Y_T, coordinate = "y"),
         Y_inter_BT_triangle_60 = inter.for.triangle(T_dist, data_circle$r0[3], b0_BT, b1_BT, 0, 0, data_circle$rmax[3]*2, X_B, Y_B, X_T, Y_T, coordinate = "y")) 
...
forest_edges_HBI.man <- 
  ...
  mutate(X_inter_AT_17_triangle = inter.for.triangle(T_dist, data_circle$r0[3], b0_AT, b1_AT, data_circle$x0[3], data_circle$y0[3], data_circle$r0[3], X_A, Y_A, X_T, Y_T, coordinate = "x"), 
         X_inter_BT_17_triangle = inter.for.triangle(T_dist, data_circle$r0[3], b0_BT, b1_BT, data_circle$x0[3], data_circle$y0[3], data_circle$r0[3], X_B, Y_B, X_T, Y_T, coordinate = "x"),
         Y_inter_AT_17_triangle = inter.for.triangle(T_dist, data_circle$r0[3], b0_AT, b1_AT, data_circle$x0[3], data_circle$y0[3], data_circle$r0[3], X_A, Y_A, X_T, Y_T, coordinate = "y"), 
         Y_inter_BT_17_triangle = inter.for.triangle(T_dist, data_circle$r0[3], b0_BT, b1_BT, data_circle$x0[3], data_circle$y0[3], data_circle$r0[3], X_B, Y_B, X_T, Y_T, coordinate = "y"),
         ...
         X_inter_AT_12_triangle = inter.for.triangle(T_dist, data_circle$r0[2], b0_AT, b1_AT, data_circle$x0[2], data_circle$y0[2], data_circle$r0[2], X_A, Y_A, X_T, Y_T, coordinate = "x"), 
         X_inter_BT_12_triangle = inter.for.triangle(T_dist, data_circle$r0[2], b0_BT, b1_BT, data_circle$x0[2], data_circle$y0[2], data_circle$r0[2], X_B, Y_B, X_T, Y_T, coordinate = "x"),
         Y_inter_AT_12_triangle = inter.for.triangle(T_dist, data_circle$r0[2], b0_AT, b1_AT, data_circle$x0[2], data_circle$y0[2], data_circle$r0[2], X_A, Y_A, X_T, Y_T, coordinate = "y"), 
         Y_inter_BT_12_triangle = inter.for.triangle(T_dist, data_circle$r0[2], b0_BT, b1_BT, data_circle$x0[2], data_circle$y0[2], data_circle$r0[2], X_B, Y_B, X_T, Y_T, coordinate = "y"),
         ...
         X_inter_AT_5_triangle = inter.for.triangle(T_dist, data_circle$r0[1], b0_AT, b1_AT, data_circle$x0[1], data_circle$y0[1], data_circle$r0[1], X_A, Y_A, X_T, Y_T, coordinate = "x"), 
         X_inter_BT_5_triangle = inter.for.triangle(T_dist, data_circle$r0[1], b0_BT, b1_BT, data_circle$x0[1], data_circle$y0[1], data_circle$r0[1], X_B, Y_B, X_T, Y_T, coordinate = "x"),
         Y_inter_AT_5_triangle = inter.for.triangle(T_dist, data_circle$r0[1], b0_AT, b1_AT, data_circle$x0[1], data_circle$y0[1], data_circle$r0[1], X_A, Y_A, X_T, Y_T, coordinate = "y"), 
         Y_inter_BT_5_triangle = inter.for.triangle(T_dist, data_circle$r0[1], b0_BT, b1_BT, data_circle$x0[1], data_circle$y0[1], data_circle$r0[1], X_B, Y_B, X_T, Y_T, coordinate = "y")) %>%  
...
trees_and_edges <-
  ...
  left_join(., forest_edges_HBI.man %>% 
              select(plot_ID, e_ID, e_type, e_form,
                    ...
                    # X_inter_AT_triangle_60_old, X_inter_BT_triangle_60_old, Y_inter_AT_triangle_60_old, Y_inter_BT_triangle_60_old, 
  ...
  mutate(t_AB_status_old = ifelse(e_form == 1 & inter_status_AB_17 == "two I" & middle.point.to.line(X1_inter_AB_17, X2_inter_AB_17, Y1_inter_AB_17, Y2_inter_AB_17, 0, 0,  data_circle$r0[3], b0_AB, b1_AB)  == "positive" & Y_AB_t_implicit > 0 |
                              ...
                              "A", "B"),
          t_AB_status = ifelse(e_form == 1, p.site.line(X1_inter_AB_17, X2_inter_AB_17, Y1_inter_AB_17, Y2_inter_AB_17, 0, 0,  data_circle$r0[3], b0_AB, b1_AB, X_tree, Y_tree), NA), 
         ...
         t_AT_status_test = p.site.triangle(X1_inter_AT_17, X2_inter_AT_17,  Y1_inter_AT_17,  Y2_inter_AT_17,
                                                     ...
                                                     X_tree, Y_tree),
         t_BT_status =ifelse(e_form == 2 & inter_status_BT_17 == "two I" & middle.point.to.line(X1_inter_BT_17, 
                                                                                                X2_inter_BT_17, 
                                                                                                Y1_inter_BT_17, 
                                                                                                Y2_inter_BT_17, 
                                                                                                0, 0,  data_circle$r0[3],
                                                                                                b0_BT, b1_BT)  == "positive" & Y_BT_t_implicit > 0 |
                               e_form == 2 & inter_status_BT_17 == "two I" & middle.point.to.line(X1_inter_BT_17, 
                                                                                                  X2_inter_BT_17, 
                                                                                                  Y1_inter_BT_17,
                                                                                                  Y2_inter_BT_17,
                                                                                                  0, 0,  data_circle$r0[3],
                                                                                                  b0_BT, b1_BT) == "negative" &  Y_BT_t_implicit < 0 | 
                               e_form == 2 & inter_status_BT_17 != "two I" , "A", "B"),
         t_BT_status_test =  p.site.triangle(X1_inter_BT_17, X2_inter_BT_17, Y1_inter_BT_17, Y2_inter_BT_17, 0, 0,  data_circle$r0[3], b0_BT, b1_BT,
                                                 X_inter_AT_triangle_60, X_inter_BT_triangle_60, X_T, Y_inter_AT_triangle_60, Y_inter_BT_triangle_60, Y_T, X_tree, Y_tree),
         ...
         t_status_AB_ABT = case_when(e_form == "1" ~  t_AB_status,
                                     ...
                                     TRUE ~ NA),
         t_status_AB_ABT_test = tree.status(e_form, 
                                            X1_inter_AB_17, X2_inter_AB_17, Y1_inter_AB_17, Y2_inter_AB_17,
                                            0, 0, data_circle$r0[3], 
                                            b0_AB, b1_AB,
                                            X_tree, Y_tree, 
                                            T_dist,
                                            X1_inter_AT_17, Y1_inter_AT_17, X2_inter_AT_17, Y2_inter_AT_17, X_A, Y_A, X_T, Y_T, b0_AT, b1_AT,  
                                            data_circle$rmax[3]*2,
                                            X1_inter_BT_17, Y1_inter_BT_17, X2_inter_BT_17, Y2_inter_BT_17, X_B, Y_B,  b0_BT, b1_BT))
...
ggplot() +  
  ...
  geom_point(data =  trees_and_edges %>% filter(e_form == "2"), 
             aes(X_tree, Y_tree, colour = t_ABT_status_test))+
  theme_bw()+ 
  facet_wrap(~plot_ID)  
...
# ----- N.1. intersections of lines AB, AT, BT with all sampling cir --------
...
mutate(inter_1_dist = distance(X1_inter_AB_17, Y1_inter_AB_17, 0, 0),     # this is just to control if the whole thing worked and 
  ...
  mutate(Y_inter_AT_triangle_60_old = l(b0_AT, b1_AT, X_inter_AT_triangle_60),  
         Y_inter_AT_triangle_60 = inter.for.triangle(T_dist, data_circle$r0[3], b0_AT, b1_AT, 0, 0, data_circle$rmax[3]*2, X_A, Y_A, X_T, Y_T, coordinate = "y"),
