...
RG_data <- read.delim(file = paste0(out.path.BZE3, "HBI_RG_update_2.csv"), sep = ",", dec = ".")
RG_removed <- read.delim(file = paste0(out.path.BZE3, unique(RG_data$inv)[1], "_RG_removed.csv"), sep = ",", dec = ".")
