...
write.csv(coeff_H_comb, paste0(out.path.BZE3, "coef_H_nls.csv"), row.names = FALSE, fileEncoding = "UTF-8") #we had to adjust this so it doesn´t save the coefficients as HBI_NA if there are no BZE3 data
...
stop("this is where notes of  height calculations BZE3 HBI start")
