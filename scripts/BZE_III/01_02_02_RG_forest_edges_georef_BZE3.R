...
# if there are edges, use the edge stands, if there are no edges set all stands to A 
if(isTRUE(exists('RG_all_edges_stands_areas') && nrow(RG_all_edges_stands_areas) != 0)){
