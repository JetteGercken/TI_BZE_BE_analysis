...
trees_removed <- read.delim(file = paste0(out.path.BZE3, "HBI_LT_removed.csv"), sep = ",", dec = ".")
...
geo_loc <- read.delim(file = paste0(getwd(), "/data/input/BZE2_HBI/location_",  trees_data$inv[1], ".csv"), sep = ",", dec = ".")
