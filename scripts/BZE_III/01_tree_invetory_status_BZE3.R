...
write.csv(HBI_trees_update_01, paste0(out.path.BZE3,"HBI_trees_update_01.csv"))
write.csv(HBI_trees_removed, paste0(out.path.BZE3,"HBI_trees_removed.csv"))
write.csv(BZE3_trees_update_01, paste0(out.path.BZE3,"BZE3_trees_update_01.csv"))
write.csv(BZE3_trees_removed, paste0(out.path.BZE3,"BZE3_trees_removed.csv"))
