...
RG_data <- read.delim(file = paste0(out.path.BZE3, "BZE3_RG_update_4.csv"),sep = ",", dec = ".")
RG_stat_2 <- read.delim(file = paste0(out.path.BZE3, RG_data$inv[1], "_RG_stat_2.csv"), sep = ",", dec = ".") %>% 
...
stop("this is where RG summary BZE3")
