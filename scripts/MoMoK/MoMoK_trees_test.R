...
rdB_DW <- function(B, dec_SP){     # a column that holds the degree of decay and the species type has to be created (united)
  rd <- c("2_1" = 1, "2_2" = (1-((0.372*1000-0.308*1000)/0.372*1000)), "2_3" = (1-((0.372*1000-0.141*1000)/0.372*1000)) , "2_4" = (1-((0.372*1000-0.123*1000)/0.372*1000)) ,   # relative change in density of conferous trees according to Faver based on 100% = 0.372
          "1_1" = 1 , "1_2" =  (1-((0.58*1000-0.37*1000)/0.58*1000)), "1_3" = (1-((0.58*1000-0.21*1000)/0.58*1000)) , "1_4" = (1-((0.58*1000-0.26*1000)/0.58*1000)) ,       #  relative change in density of broadleaved trees according to Müller-Ursing basen on 100% = 0.58
          "3_1" = 1, "3_2" = (1-((0.58*1000-0.37*1000)/0.58*1000)), "3_3" = (1-((0.58*1000-0.21*1000)/0.58*1000)), "3_4" = (1-((0.58*1000-0.26*1000)/0.58*1000)) );      # relative change in density of oak trees according to Müller-Ursing basen on 100% = 0.58
  return(B*rd[dec_SP])
}
...
# mutate(dw_tapes_swB_meth= ifelse(DW_type %in% c(2, 5) & dec_type_BWI < 3  & L_m  > 1.3 & !is.na(D_h_m), "tapes_swB", 
#                                     ifelse(DW_type == 3 & dec_type_BWI < 3 & !is.na(dw_tapes_b_ratio),  "sw_tapeS_wood",
#                                            "no"))
...
wd_ho_used <- c(6, 7, 9, 7, 8, 8, 7, 9, 6,  0,  0)
...
current_KW_week <- 43 # 16.10.2023 -22.10.2023.
