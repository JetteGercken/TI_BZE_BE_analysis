...
for (i in 1:length(code_table_names)) {
  ...
  write.csv(df, paste0(here::here("data/raw/general"), "/", my.table.name, ".csv"), row.names = FALSE)
}
...
raw.path.code <- paste0(here::here("data/raw/general"), "/")
...
# 3. create input path
input.path.code <- paste0(here::here("data/input/general"), "/")
...
for (i in 1:length(data_table_names)) {
  ...
  df <- dbGetQuery(con, paste0("SELECT * FROM"," ", my.schema.name,".", my.table.name))
  # name dataframe and export it to raw data folder
  write.csv(df, paste0(here::here("data/raw/BZE2_HBI"), "/", my.table.name, ".csv"), row.names = FALSE)
...
for (i in 1:length(data_table_names_2)) {
  ...
  df <- dbGetQuery(con, paste0("SELECT * FROM"," ", my.schema.name,".", my.table.name))
  # name dataframe and export it to raw data folder
  write.csv(df, paste0(here::here("data/raw/BZE2_HBI"), "/", "location_HBI", ".csv"), row.names = FALSE)
...
# 1. create raw data path: 
raw.path.bze2 <- paste0(here::here("data/raw/BZE2_HBI"), "/")
# 2. get names of all files in the momok outout folder: https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/list.files
bze2.in.files <- list.files(raw.path.bze2) 
# 3. create input path
input.path.bze2 <- paste0(here::here("data/input/BZE2_HBI"), "/")
# copy the files from one filder to the other: https://statisticsglobe.com/move-files-between-folders-r
...
for (i in 1:length(data_table_names)) {
  ...
  write.csv(df, paste0(here::here("data/raw/BZE2_HBI"), "/", "location_HBI", ".csv"), row.names = FALSE)
  # name dataframe 
  write.csv(df, paste0(here::here("data/input/BZE3"), "/", my.table.name, ".csv"), row.names = FALSE)

}
# 2.3.2. copy data files from raw data bze3 to input bze3 fo -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# save everything imported from database from raw folder to input folder
# 1. create raw data path: 
raw.path.bze3 <- paste0(here::here("data/raw/BZE3"), "/")
# 2. get names of all files in the momok outout folder: https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/list.files
bze3.in.files <- list.files(raw.path.bze3) 
# 3. create input path
input.path.bze3 <- paste0(here::here("data/input/BZE3"), "/")
# copy the files from one filder to the other: https://statisticsglobe.com/move-files-between-folders-r
